...
init:function() {
    ...
    GAME.platforms.push(new GAME.Platform({x:0, y:-1500, z:0, width:10000, height:200,color:0x000000, velocityX:0, velocityY:0,mass:1}));
    ...
    GAME.platforms.push(new GAME.Platform({x:0, y:-1012, z:10, width:1024, height:1024,map:GAME.Textures['announcementstext'].threeObj, color:0x000000, velocityX:0, velocityY:0,mass:10}));
    GAME.platforms.push(new GAME.Platform({x:1575, y:-1012, z:10, width:1024, height:1024,map:GAME.Textures['contacttext'].threeObj, color:0x000000, velocityX:0, velocityY:0,mass:10}));
